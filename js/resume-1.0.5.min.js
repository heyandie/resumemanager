...
ko.mapping.fromJS(data,{},self);}
var currentscheme=new colorSchemeModel({color:"yellow",selected:true});self.color_palette=ko.observableArray([currentscheme,new colorSchemeModel({color:"orange",selected:false}),new colorSchemeModel({color:"plum",selected:false}),new colorSchemeModel({color:"blue",selected:false})]);}
