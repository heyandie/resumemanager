...
self.isPersonalInfo=ko.observable(false);self.isEducation=ko.observable(false);self.isWorkExp=ko.observable(false);self.isExtraCurr=ko.observable(false);self.isSubmit=ko.observable(true);self.isPreview=ko.observable(true);self.isSkills=ko.observable(false);self.isConfirmed=ko.observable(false);self.showPersonalInfo=function(){if(self.isPersonalInfo())
